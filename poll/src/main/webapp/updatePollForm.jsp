...
<body>
	...
	<form method="post" action="/poll/UpdatePollAction.jsp">
		...
		<table border="1">
			...
			<tr>
				<td>3) <input type="text" name="content" value="<%=listSize > 2 ? itemList.get(0).getContent() : ""%>"></td>
				<td>4) <input type="text" name="content" value="<%=listSize > 3 ? itemList.get(0).getContent() : ""%>"></td>
			</tr>
			<tr>
				<td>5) <input type="text" name="content" value="<%=listSize > 4 ? itemList.get(0).getContent() : ""%>"></td>
				<td>6) <input type="text" name="content" value="<%=listSize > 5 ? itemList.get(0).getContent() : ""%>"></td>
			</tr>
			<tr>
				<td>7) <input type="text" name="content" value="<%=listSize > 6 ? itemList.get(0).getContent() : ""%>"></td>
				<td>8) <input type="text" name="content" value="<%=listSize > 7 ? itemList.get(0).getContent() : ""%>"></td>
			</tr>
			<tr>
				<td>시작일</td>
